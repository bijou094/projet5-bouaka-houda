...
function getAllCameras(){
  ...
  .then( function(data) {    
    for (let i=0 ; i< data.length; i++){      
      ...
      addAllCameras (_id, imageUrl, name, price);  
    }      
  });
};
getAllCameras();
/************************************************************ */
// création, personalistion et ajout les cameras dans le DOM
function addAllCameras  (_id, imageUrl, name, price ){        
  ...
  nouveauCameras.innerHTML=`
    <a class="text-decoration-none"  href="./ficheProduit.html?id=${_id}">       
      <div class="card-img-top">
        <img src="${imageUrl}" class=" card-img-top img-fluid imageCameras" alt="photo de la caméra choisie ">
      </div>
